...
class IntercomTransformer {
  constructor() {
    ...
    this.fieldMapping = {
      ...
      'Teammate first replied': 'teammate_first_replied',
      'Teammate replied to': 'teammate_replied_to',
      'Company name': 'company_name',
      'First response time excluding time spent in bot inbox (seconds)': 'first_response_time_seconds',
      'Time to close excluding bot inbox time (seconds)': 'time_to_close_seconds',
